#!/usr/bin/env python3
"""Automatizovaný OAuth pre Saxo DEMO (sim).

Tento skript:
1. Vygeneruje autorizačnú URL pre sim prostredie.
...
- Spusti: python auto_oauth_demo.py
...
class CallbackHandler(BaseHTTPRequestHandler):
    def do_GET(self):
        global Handler
        if self.path.startswith("/callback/demo"):
...
def main():
    ...
    print("Autorizačná URL pre DEMO:")
    print(url)
    print("\nOtvorte túto URL v prehliadači, prihláste sa do Saxo demo účtu a potvrďte oprávnenia.")
